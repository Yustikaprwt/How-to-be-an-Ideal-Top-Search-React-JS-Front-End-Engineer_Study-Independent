import { gql, useQuery, useLazyQuery, from } from "@apollo/client";
  ...
  return (
    <div>
      ...
      <ListPassenger 
        data={dataQuery}
      />
      <input onChange={onChangeLazy} type="text" placeholder="Masukkan Id Pengunjung..." style={{width: 210, margin: "25px 5px"}}></input>
